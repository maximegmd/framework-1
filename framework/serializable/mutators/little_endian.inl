    ...
    namespace serializable
    {
        ...
        namespace detail
        {
...
#if FRAMEWORK_HOST_ENDIANESS == FRAMEWORK_LITTLE_ENDIAN
#elif FRAMEWORK_HOST_ENDIANESS == FRAMEWORK_BIG_ENDIAN
            ...
            struct little_endian_impl <T, typename std::enable_if <std::is_floating_point <T>::value, void>::type>
            {
                ...
                {
                    (void)value; // suppress unused value warning
#if FRAMEWORK_HOST_FLOAT_ENDIANESS == FRAMEWORK_LITTLE_ENDIAN
#elif FRAMEWORK_HOST_FLOAT_ENDIANESS == FRAMEWORK_BIG_ENDIAN
                    std::reverse(reinterpret_cast <char*> (&value), reinterpret_cast <char*> (&value) + sizeof(value));
#else
