...
namespace framework
{
    namespace serializable
    {
        ...
        *
        * Serializes the child type T using little endian byte ordering.  FRAMEWORK_HOST_ENDIANESS
        * and FRAMEWORK_HOST_FLOAT_ENDIANESS define the host endianess; see framework/common/endian.hpp.
        *
        * \note
        ...
        */
        template <typename T>
        struct little_endian : public mutator_type <little_endian <T>, T>
        {
        };
