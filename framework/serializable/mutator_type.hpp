...
namespace framework
{
    namespace serializable
    {
        ...
        *
        * \tparam Specification specification used to serialize the mutator
        * \tparam Child wrapped child type
        */
        template <typename Specification, typename Child>
#ifndef DOXYGEN
        struct mutator_type;
#else
        struct mutator_type
        ...
        * \headerfile mutator_type.hpp <framework/serializable/mutator_type.hpp>
        *
        * Retrieves a mutator type's specification, storing the result in \c type.
        *
        * \pre is_mutator_type <T>::value == true
        */
        template <typename T>
        struct get_mutator_specification
        {
            /**
            * \brief Result.
            */
            using type =
                typename std::enable_if <
                    ...
                    typename T::mutator_specification
                >::type;
        };
